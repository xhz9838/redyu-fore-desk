...
!function (e, a) {
    ...
    var e = function () {
        ...
        function r(e) {
            var a = null;
            if (e.replacer) a = e.replacer.apply({config: d}, [":" + e.emojiName + ":", e.emojiName]); else {
        ...
        function s(o, r) {
            ...
            return o.replace(c, function () {
                var e = Array.prototype.slice.call(arguments, 0, -2), a = arguments[arguments.length - 2],
                    o = arguments[arguments.length - 1], i = t.validate(e, a, o);
                return i ? r.apply({config: d}, [arguments[0], i]) : arguments[0]
            })
        }
        ...
        function l(o, i) {
            ...
            var s = o.ownerDocument, l = s.defaultView || s.parentWindow, u = function (e, a) {
                ...
                for (var _ = o.length; _-- > 0;) {
                    var u = t(o[_]);
                    r({node: e, match: o[_], emojiName: u, replacer: i, win: l})
                }
            };
            _ = e(), c = a();
            var m = [], h = new RegExp(d.blacklist.elements.join("|"), "i"),
        ...
        return n.prototype = {
            ...
            defaultConfig: d, emojiNames: g, setConfig: function (e) {
