...
var _createClass = function () {
...
}, instance = !1, baseUrl = LocalConst.BASE_SCRIPT_URL, skPlayer = function () {
    function a(b) {
        var c = this;
        if (_classCallCheck(this, a), instance) return console.error("SKPlayer只能存在一个实例！"), Object.create(null);
        instance = !0;
        var d = {element: document.getElementById("skPlayer"), autoplay: !1, mode: "listloop", listshow: !0};
        ...
        this.root = this.option.element, this.type = this.option.music.type, this.music = this.option.music.source, this.media = this.option.music.media, this.isMobile = /mobile/i.test(window.navigator.userAgent), this.isReady = !1, this.toggle = this.toggle.bind(this), this.toggleList = this.toggleList.bind(this), this.toggleMute = this.toggleMute.bind(this), this.switchMode = this.switchMode.bind(this), "file" === this.type ? (this.root.innerHTML = this.template(), this.init(), this.bind(), this.isReady = !0) : "cloud" === this.type && (this.root.innerHTML = '<p class="skPlayer-tip-loading"><span></span> <span></span> <span></span> <span></span><span></span></p>', Util.ajax({
            ...
            success: function (a) {
                c.music = JSON.parse(a),
                    c.root.innerHTML = c.template(),
                    c.init(), c.bind()
            },
            fail: function (a) {
    ...
    return _createClass(a, [{
        key: "notice", value: function (a, b) {
            $.message({title: LocalConst.MUSIC_NOTICE, message: a, type: b})
        }
    }, {
        ...
        key: "init", value: function () {
            ...
            if (this.dom = {
                ...
                volumebutton: this.root.querySelector(".skPlayer-volume-icon"),
                ...
                if (this.option.autoplay && !this.isMobile) {
                    ...
                    $.message({
                        title: "音乐播放",
                        message: "即将自动播放，点击<a class='stopMusic'>停止播放</a>",
                        type: "warning"
                    }), setTimeout(function () {
                        b && a.play()
                    }, 3050)
            ...
            "cloud" === this.type && Util.ajax({
                url: baseUrl + "/music/" + this.music[0].song_id,
                beforeSend: function () {
                },
                success: function (b) {
                    var c = JSON.parse(b).url;
                    if (null !== c) a.isReady = !0, a.audio.src = c; else {
        ...
        key: "bind", value: function () {
            ...
            this.updateLine = function () {
                ...
                if ("LI" === b.target.tagName.toUpperCase()) c = b.target; else {
        ...
        key: "switchMusic", value: function (a) {
            ...
            return "number" != typeof a ? void console.error("请输入正确的歌曲序号！") : (a -= 1) < 0 || a >= this.music.length ? void console.error("请输入正确的歌曲序号！") : a == this.dom.musiclist.querySelector(".skPlayer-curMusic").getAttribute("data-index") ? void this.play() : (this.dom.musiclist.querySelector(".skPlayer-curMusic").classList.remove("skPlayer-curMusic"), this.dom.musicitem[a].classList.add("skPlayer-curMusic"), this.dom.name.innerHTML = this.music[a].name, this.dom.author.innerHTML = this.music[a].author, this.dom.cover.src = this.music[a].cover, void("file" === this.type ? void 0 !== this.music[a].src ? (this.audio.src = this.music[a].src, this.isReady = !0, this.play()) : this.errorHandle(a) : "cloud" === this.type && Util.ajax({
                url: baseUrl + "/music/" + this.music[a].song_id,
                beforeSend: function () {
                },
                success: function (a) {
        ...
        key: "toggleMute", value: function () {
            this.audio.muted ? (this.audio.muted = !1, this.dom.volumebutton.innerHTML = '<svg viewBox="0 0 24 24" width="14" height="14" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path></svg>', this.dom.volumeline_value.style.width = Util.percentFormat(this.audio.volume)) : (this.audio.muted = !0, this.dom.volumebutton.innerHTML = '<svg viewBox="0 0 24 24" width="14" height="14" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon><line x1="23" y1="9" x2="17" y2="15"></line><line x1="17" y1="9" x2="23" y2="15"></line></svg>', this.dom.volumeline_value.style.width = "0%")
        }
    }, {
...
var player = new skPlayer({
    ...
    "listshow": false,
    "mode": "listloop",
    "music": {"type": "cloud", "source": "99683852", "media": "netease"}
});
