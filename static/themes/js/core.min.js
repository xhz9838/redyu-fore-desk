...
window['LocalConst'] = {
    ...
    IS_PJAX: '1',
    IS_PAJX_COMMENT: '1',
    BASE_SCRIPT_URL: 'http://114.55.104.60:81/tinkle',//音乐接口
    BLOG_URL: 'http://www.redyu.run/',//博客前台URL
    BLOG_API: 'http://www.redyu.run:10002/dev-api/',
    THEME_COLOR: '14',
...
var parsePhotos = function () {
    $.each($(".album-photos figure"), function (a, b) {
        ...
        "1" === LocalConst.LAZY_LOAD ? c.src = $(b).find("img").attr("data-src") : c.src = $(b).find("img").attr("src"), c.onload = function () {
            var a = parseFloat(c.width), d = parseFloat(c.height);
    ...
    $("#search_input").on("input", function () {
        setTimeout(function () {
            a || (null !== c && clearTimeout(c), c = setTimeout(function () {
                ...
                if ("" !== a.trim()) {
                    $("#spin-search").addClass("show inline"), $("#icon-search").addClass("hide"), null !== b && (b.abort(), b = null), b = $.getJSON(LocalConst.BLOG_API+"content/archive/search/" + a, function (a) {
                        $("#search_tips_drop").text(""), $("#search_tips_drop").removeClass("hide"), $(a.data.results).appendTo("#search_tips_drop"), $("#spin-search").removeClass("show inline"), $("#icon-search").removeClass("hide"), b = null
                    })
                } else $("#search_tips_drop").text(""), $("#search_tips_drop").addClass("hide");
    ...
    searchInput(), $(document).on("click", function (a) {
...
var initTheme = function () {
    ...
    a.indexOf("Safari") > -1 && a.indexOf("Chrome") < 1 && $("#left_footer").addClass("hide"), $(document).on("click", "[ui-toggle-class]", function (a) {
        ...
        var c = b.attr("ui-toggle-class").split(","), d = b.attr("target") && b.attr("target").split(",") || Array(b),
            e = 0;
        $.each(c, function (a, b) {
            var f = d[d.length && e];
            $(f).toggleClass(c[a]), e++
        ...
        a.preventDefault();
        var b = $(this), c = b.data("toggle-class"), d = {};
    ...
    $(document).on("click", "[ui-nav] a,[ui-nav-fold] a", function (a) {
        ...
        if (c.parent().siblings(".active").toggleClass("active"), c.next().is("ul") && c.parent().toggleClass("active") && a.preventDefault(), $(".app-aside-fix").length > 0 && $(window).width() > 768) {
            var d, c = $(a.target), e = $(window).height();
    ...
    $(document).on("mouseenter", "[ui-nav] a", function (a) {
        if (console.log("mouseenter2"), $(document).on("mouseenter", ".app-aside>ul.nav", function (a) {
            c = !0
        }), $(document).on("mouseleave", ".app-aside>ul.nav", function (a) {
            c = !1
        }), b && b.trigger("mouseleave.nav"), $("> .nav", $(".app-aside")).remove(), $(".app-aside-fix").length && !($(window).width() < 768)) {
            var d, e = $(a.target), f = $(window).height();
            !e.is("a") && (e = e.closest("a")), e.next().is("ul") && (b = e.next(), $(".app-aside-folded").length && (e.parent().addClass("active"), b.appendTo(".app-aside"), d = e.parent().position().top, b.css("top", d), b.attr("ui-nav-fold", ""), d + b.height() > f && b.css("bottom", "50px"), d + 150 > f && b.css("bottom", f - d - 50).css("top", "auto"), b.on("mouseleave.nav", function (a) {
                c || (b.appendTo(e.parent()), b.off("mouseleave.nav").css("top", "auto").css("bottom", "auto"), e.parent().removeClass("active"), c = !1)
        ...
        c = !1, b && b.trigger("mouseleave.nav"), $("> .nav", $(".app-aside")).remove()
...
$.extend({
    Module_Timer: function (a) {
        function b(a) {
            ...
            } else j = window.requestAnimationFrame(b);
            u--
        }

        function c(a, b) {
            return parseInt(100 * parseFloat(a / b))
        }
        ...
        var e, f, g, h, i, j, k = a.id, l = document.getElementById(k);
        l = $(l);
        var m = l.find(".span-days"), n = l.find(".pie-days"), o = l.find(".span-hours"), p = l.find(".pie-hours"),
            q = l.find(".span-minutes"), r = l.find(".pie-minutes"), s = l.find(".span-seconds"),
        ...
        e = a.leaveTime, f = e / 86400 >> 0, g = (e - 86400 * f) / 3600 >> 0, h = (e - 3600 * g - 86400 * f) / 60 >> 0, i = e % 60, n.easyPieChart({
            ...
            lineCap: "butt",
            animate: 1e3
        }), r.data("easyPieChart").update(c(h, 60)), t.data("easyPieChart").update(c(i, 60)), p.data("easyPieChart").update(c(g, 24)), n.data("easyPieChart").update(c(f, 10)), m.text(d(f)), o.text(d(g)), q.text(d(h)), s.text(d(i)), function () {
            j = window.requestAnimationFrame(b)
        }();
        var u = 60
    }
}), function (a) {
    "use strict";
    a(function () {
        initTheme(), b(), l(), console.info("q()"), a(".skPlayer-list-switch").bind("click", function () {
            player.toggleList()
    ...
    var b = function () {
        feather.replace({
            width: "16px",
            height: "16px"
        }), parsePhotos(), e(), a(".off-screen-toggle").click(function () {
        ...
        })) : LocalConst.COMMENT_SYSTEM === LocalConst.COMMENT_SYSTEM_CHANGYAN && n(), LocalConst.IS_PAJX_COMMENT ? console.info("p()") : console.info("r()"), o(), "function" == typeof registCommentEvent && registCommentEvent(), LocalConst.THEME_HEADER_FIX && t(), LocalConst.THEME_TOC && j(), h(), i(), k(), f(), window.Page.seFancyBox(), a("#post-content").find("table").wrap("<div class='table-responsive box-shadow-wrap-lg'></div>"), LocalConst.THEME_HIGHLIGHT_CODE && s(), d(), c()
    }, c = function () {
        a(".plus-font-size").click(function () {
            var b = a("#post-content").css("font-size"), c = parseFloat(b, 10);
            b.slice(-2);
        ...
        a('input[name = "mail"]').blur(function () {
            var b = a(this).val();
            return "" != b && a.ajax({
                url:LocalConst.BLOG_API+"content/comment/avatar/"+b,
                type: "GET",
                // data: {action: "ajax_avatar_get", form: LocalConst.BLOG_API, email: b},
                success: function (b) {
        ...
        if (a(d).modal("hide"), document.selection) {
            ...
            var e = b.selectionStart, f = b.selectionEnd, g = e;
        ...
        a(".weixinAudio").each(function () {
            var b = a(this), c = b.children("audio"), d = b.find(".audio_title"), e = b.find(".audio_source"),
                f = b.children("input[ name='url']").attr("value");
            "" !== f ? a.ajax({
                type: "GET", url: f, error: function (a) {
                }, success: function (b) {
                    var f = a.parseJSON(b);
        ...
        a(".weixinAudio").on("click", function (c) {
            var d = a(this), e = d.index(".weixinAudio");
        ...
        var b = a("#goToTop");
        a(b).click(function () {
            a("body,html").animate({scrollTop: 0}, 600)
        }), a(window).scroll(function () {
            a(window).scrollTop() > 200 ? b.removeClass("hide") : b.addClass("hide")
        })
    }, m = function () {
        var a = document.getElementsByClassName("OwO")[0], b = document.getElementsByClassName("OwO-textarea")[0];
        if (void 0 != a && void 0 != b) {
            new OwO({
                logo: LocalConst.EMOJI,
                container: a,
                target: b,
                api: LocalConst.BLOG_URL + "usr/OwO.json?v=" + LocalConst.THEME_VERSION,
                position: "down",
                width: "100%",
                maxHeight: "220px"
            })
    ...
    //         e = "#comments .comments-title", f = ".comment-reply", g = "#comment", h = "#submit", i = "", j = "";
    ...
    //                 try {
    //                     if (!a(".comment-list", k).length) return console.log(a("div", k)), "undefined" != typeof content && "" != content || (content = LocalConst.COMMENT_CONTENT_LEGAL_INFO), a.message({
    //                         title: LocalConst.COMMENT_TITLE,
    //                         message: content,
    //                         type: "error"
    //                     }), a(h).removeClass("active"), a("#spin").removeClass("show inline"), c("#error"), !1;
    ...
    //             error: function () {
    //                 return a.message({title: "提交通知", message: "提交失败，检查网络问题", type: "warning"}), !1
    //             },
    //             success: function (b) {
    //                 try {
    ...
    //                         type: "warning"
    //                     }), !1;
    //                     var c = a("#post-content", b).html(), d = a("#comments", b).html(),
    ...
    //         var c = a("#navbar-login-user").val(), d = a("#navbar-login-password").val();
    //         return "" == c ? (a.message({
    ...
    r = function () {
        a("#submit").bind("click", function () {
            var b = a("#author").val(), c = a("#mail").val();
     ...
     s = function () {
        ...
        a("#comments,#small_widgets").delegate("a[href^=\\#][href!=\\#]", "click", function () {
            ...
            if (b) {
                ...
                return a("html,body").animate({scrollTop: c}, 300), !1
            }
        });
        var b = decodeURIComponent(window.location.hash);
        window.location.hash.indexOf("#") >= 0 && a(b).length && setTimeout(function () {
            a("html,body").animate({scrollTop: a(b).offset().top - LocalConst.OFF_SCROLL_HEIGHT + "px"}, 400)
        }, 700)
    };
    window.Page = {
        seFancyBox: function () {
            a.fancybox.defaults.buttons = ["zoom", "download", "thumbs", "close"], a("#post-content img, #comments img,.streamline img").each(function () {
                var b = a(this);
                if (void 0 !== b.attr("alt")) var c = b.attr("alt"); else var c = "";
                var d = b.parent("a"), e = typeof b.attr("noGallery"), f = typeof b.attr("imgBlur");
...
}(jQuery), console.log("\n %c handsome v6.0 Pro %c by Redyu C | redyu.run", "color:#444;background:#eee;padding:5px 0;", "color:#eee;background:#444;padding:5px 0;");