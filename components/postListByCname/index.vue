      ...
      <div class="hbox hbox-auto-xs hbox-auto-sm">
        <div class="col center-part">
          <header class="bg-light lter wrapper-md">
            <h1 class="m-n font-thin h3 text-black l-h">分类 {{$route.params.cname}} 下的文章</h1>
          </header>
          <div class="wrapper-md" id="post-panel">
            <ol class="breadcrumb bg-white-pure" itemscope>
              ...
              <li class="active">{{$route.params.cname}}</li>
            </ol>
            <!-- 输出文章 TODO:整合该部分代码-->
...
export default {
  name: "PostListByCname",
  components: {
    Sidebar
  },
  computed: {
      currentPage(){
       return parseInt(this.archivePageInfo.pageNum)
      }
  },
  props: {
    archivePageInfo: {
  ...
  methods: {
    handleCurrentChange(val) {
      this.$router.push("/category/" + this.$route.params.cname + "/" + val);
    }
  }
};
</script>
